...
export const PREMIUM_ENTITLEMENT_MATRIX: readonly PremiumEntitlementRow[] = [
  {
    ...
    notes: 'Đang được gate qua luồng reveal contact.',
  },
  {
    id: 'favorites',
    ...
    notes: 'Đang enforce ở lane favorites.',
  },
  {
    id: 'roommate_views',
    title: 'Xem hồ sơ roommate',
    status: 'live',
    kind: 'hard_entitlement',
    freeValue: `${FREE_LIMITS.ROOMMATE_VIEWS_PER_DAY} lượt/ngày`,
    premiumValue: 'Không giới hạn',
    notes: 'Đang enforce server-side.',
  },
  {
    id: 'roommate_requests',
    title: 'Gửi lời chào / yêu cầu roommate',
    status: 'live',
    kind: 'hard_entitlement',
  ...
  },
  {
    ...
    title: 'Deal Premium Local Passport',
    status: 'live',
    kind: 'hard_entitlement',
    freeValue: 'Chỉ xem deal thường',
    premiumValue: 'Mở khóa deal Premium',
    notes: 'Đang gate theo `is_premium_only`.',
  },
  {
    id: 'premium_badge',
    ...
    kind: 'soft_signal',
    freeValue: 'Không có',
    premiumValue: 'Hiển thị badge Premium',
    notes: 'Chủ yếu là social signal, không phải core value.',
  },
  {
    id: 'priority_display',
