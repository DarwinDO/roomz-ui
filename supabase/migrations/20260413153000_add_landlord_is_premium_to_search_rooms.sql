-- Add landlord premium metadata to search_rooms for avatar ring rendering
-- Date: 2026-04-13

DROP FUNCTION IF EXISTS public.search_rooms(
    text,
    text,
    numeric,
    numeric,
...
BEGIN
    ...
    WITH base AS (
        SELECT
            ...
            u.is_premium AS landlord_is_premium,
